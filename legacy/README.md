...
1. **Clone the Repository:**
   ...
   git clone https://github.com/IAmTomShaw/f1-race-replay
    cd f1-race-replay
     ```
     The legacy desktop application is launched from the repository root with
     `.venv/bin/python legacy/main.py`, or from this `legacy/` directory with
     `python main.py`.
...
The commands below are shown from the repository root. When working from this
directory instead, use `python main.py` in place of
...
```bash
.venv/bin/python legacy/main.py --cli
```
...
```bash
.venv/bin/python legacy/main.py --viewer --year 2025 --round 12
```

To run without HUD:
```bash
.venv/bin/python legacy/main.py --viewer --year 2025 --round 12 --no-hud
```

To run a Sprint session (if the event has one), add `--sprint`:
```bash
.venv/bin/python legacy/main.py --viewer --year 2025 --round 12 --sprint
```
...
```bash
.venv/bin/python legacy/main.py --viewer --year 2025 --round 12 --refresh-data
```
...
```bash
.venv/bin/python legacy/main.py --viewer --year 2025 --round 12 --qualifying
```

To run a Sprint Qualifying session (if the event has one), add `--sprint`:
```bash
.venv/bin/python legacy/main.py --viewer --year 2025 --round 12 --qualifying --sprint
```
...
- Run the example from `legacy/`: `python -m src.insights.example_pit_wall_window`
- Test the menu from `legacy/`: `python -m src.gui.insights_menu`
