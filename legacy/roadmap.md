...
> **Status:** Historical material, retained as a snapshot of the legacy desktop
> project's aspirations. It is not a current project plan, commitment, or
> browser-replay roadmap.
>
> **Source and date qualification:** The original roadmap text in this
> repository is the source. Its publication/update date was not recorded; the
> status was reviewed on 2026-08-15.

The original roadmap preserved the following vision and community notes. The
items below should not be interpreted as active work or supported migration
plans for the current browser replay.
...
- **GUI Menu System:** Implement a user-friendly graphical interface to navigate through the different race weekends, sessions and available formats for reviewing data. (The original snapshot attributed this work to [@IAmTomShaw](https://github.com/IAmTomShaw); no current status is asserted.)
...
## Historical contribution invitation
