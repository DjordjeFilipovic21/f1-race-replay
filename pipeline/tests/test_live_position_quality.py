...
from f1_replay_pipeline.live_position_projection import ProjectionGeometryError
from f1_replay_pipeline.live_position_quality import QUALITY_GATE_VERSION, assess_projection_quality
