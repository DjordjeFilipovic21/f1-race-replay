...
from f1_replay_pipeline.analysis.live_position.live_position_ranking import (
    BatchRankingFrame,
    DriverProgressInput,
    RankingState,
...
def test_batch_uses_one_binary_search_per_non_leader_gap(monkeypatch):
    import f1_replay_pipeline.analysis.live_position.live_position_ranking as ranking
